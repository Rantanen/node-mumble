...
var MumbleWrapper = function(connection) {
     ...
     * functionality on the {@MumbleWrapper} class instead.
     *
     * @name MumbleWrapper#connection
     ...
     *
     * @name MumbleWrapper#rootChannel
     * @type Channel
     */
 ...
 *
 * @event MumbleWrapper#user-connect
 ...
 *
 * @event MumbleWrapper#channel-create
 *
...
/**
 * @summary Find a specific channel by its channelId.
 *
 ...
 */
MumbleWrapper.prototype.userBySession = function( id ) {
 ...
 * @param {Number[]} recipients.channelId - Channel IDs of target channels.
 */
MumbleWrapper.prototype.sendMessage = function( message, recipients ) {
    var packet = {
        actor: this.session,
        message: message
    };
...
/**
 * @summary Wraps source events to be emitted from the Wrapper as well.
 *
 * @private
 *
