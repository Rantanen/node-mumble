...
User.prototype.moveToChannel = function(channel) {
    ...
    this.client.connection.sendMessage( 'UserState', { session: this.session, actor: this.client.user.session, channelId: id });
};
...
User.prototype._applyProperties = function(data) {
    ...
    if(data.channelId !== undefined) {
        this.channel = this.client.channelById(data.channelId);
    }
...
User.prototype._checkChangeChannel = function( data ) {
    ...
    var newChannel = this.client.channelById( data.channelId );
