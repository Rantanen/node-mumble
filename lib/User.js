 ...
 * @param {Boolean} [ban] - If true, this will attempt to ban the user as well.
 */
User.prototype.kick = function(reason, ban) {
    this.client.connection.sendMessage( 'UserRemove', { session.this.session, actor: this.client.user.session, reason: reason, ban: ban } );
};
